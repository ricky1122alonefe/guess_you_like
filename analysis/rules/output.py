...
def recommendation_to_baseline(rec: Recommendation) -> dict:
    ...
    return {
        ...
        "reference_result_1x2": rec.reference_result_1x2,
        "reference_result_1x2_cn": rec.reference_result_1x2_cn,
        "reference_blend_summary": rec.reference_blend_summary,
        "jingcai_divergence": rec.jingcai_divergence,
...
def recommendation_from_dict(data: dict) -> Recommendation:
    return Recommendation(
        ...
        reference_result_1x2=data.get("reference_result_1x2", ""),
        reference_result_1x2_cn=data.get("reference_result_1x2_cn", ""),
        reference_blend_summary=data.get("reference_blend_summary", ""),
        jingcai_divergence=data.get("jingcai_divergence"),
